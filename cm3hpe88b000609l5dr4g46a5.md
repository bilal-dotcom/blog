...
> ffuf -u [http://10.10.204.28/login.php](http://10.10.204.28/login.php) -d 'username=FUZZ&password=test' -w [list.md](http://list.md) -fc 200 -H "Content-Type: application/x-www-form-urlencoded; charset=UTF-8"
...
* `ffuf -u http://website.com/FUZZ -w wordlists/common.txt`
