...
2. **Fuzzing d’extensions**
    ...
    * `ffuf -u http://website.com/indexFUZZ -w PATH/TO/WEB-EXTENSIONS.TXT`
...
Il existe plusieurs listes de payloads d’injection SQL disponibles en ligne. Voici un exemple [ici](https://github.com/payloadbox/command-injection-payload-list?source=post_page-----04e67b89e394---------------------------------------).
