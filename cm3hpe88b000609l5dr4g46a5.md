...
* `ffuf -u http://website.com/FUZZ -w PATH/TO/WORDLISTS -recursion`
...
Le fuzzing de paramètres est utilisé pour découvrir des paramètres d’URL et tester différentes valeurs. Il consis
