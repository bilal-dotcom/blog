...
Un article disponible [ici](https://blog.fikara.io/penetration-testing-metasploit), montre un pentest de Metasploit avec une machine Kali Linux sur une machine vulnérable Metaspoitable